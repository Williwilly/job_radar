...
Built to solve a personal problem — tracking remote product analyst and data 
roles across multiple job boards without manual searching daily. Runs on a 
schedule via Windows Task Scheduler and outputs to Excel with application 
status tracking.
